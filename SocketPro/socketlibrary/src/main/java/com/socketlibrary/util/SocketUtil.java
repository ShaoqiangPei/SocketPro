...
public class SocketUtil {
    ...
    public static void i(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, SocketUtil.LEVEL_I);
        }
    }
    ...
    public static void d(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, SocketUtil.LEVEL_D);
        }
    }
    ...
    public static void w(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, SocketUtil.LEVEL_W);
        }
    }
    ...
    public static void v(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, SocketUtil.LEVEL_V);
        }
    }
    ...
    public static void e(String tag, String msg) {
        if (LOG) {
            printLog(formatLog(tag), msg, SocketUtil.LEVEL_E);
        }
    }
...
//        buffer.append(className + ".");
    ...
    private static void printByLogType(String tag, String msg, String type) {
        switch (type) {
            case SocketUtil.LEVEL_I:
                android.util.Log.i(tag, msg);
                break;
            case SocketUtil.LEVEL_D:
                android.util.Log.d(tag, msg);
                break;
            case SocketUtil.LEVEL_W:
                android.util.Log.w(tag, msg);
                break;
            case SocketUtil.LEVEL_V:
                android.util.Log.v(tag, msg);
                break;
            case SocketUtil.LEVEL_E:
